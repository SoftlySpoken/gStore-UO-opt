...
class Optimizer
{
 public:
  ...
  Optimizer(KVstore* kv_store, Statistics *statistics, BGPPlan* bgp_plan, TYPE_TRIPLE_NUM* pre2num, TYPE_TRIPLE_NUM* pre2sub,
  ...
  pair<long long, long long> get_est_for_BGP(std::shared_ptr<BGPQuery> bgp_query);
